...
SECRETARIA DE PARTICIPACION CIUDADANA Y DESCENTRALIZACION

SUBSECRETARIA DE GOBIERNO DIGITAL Y MEJORA DE PROCESOS

Concurso Interno de Oposicion y Antecedentes

CARGO: JEFE DE DEPARTAMENTO DE GESTION, DESARROLLO E INNOVACION EN SISTEMAS DE SOFTWARE

C.F. 1-31-00-01 | N de Orden 6733

PLAN DE TRABAJO

Diagnostico Integral y Propuesta de Mejora para el Funcionamiento del Departamento de Gestion, Desarrollo e Innovacion en Sistemas de Software: Optimizacion con Recursos Actuales y Proyeccion con Incorporacion de Recursos

Optimizando los procedimientos organizacionales como columna vertebral para asegurar un software escalable, seguro y sostenible

Postulante:Guido Cassulo

Legajo N:[Completar Legajo]
...
• Disponibilidad de Herramientas e Infraestructura Base:

El Departamento ya dispone de herramientas institucionales preexistentes como GitLab para el versionado y almacenamiento del código fuente, Redmine para la gestión de proyectos, y la existencia de ambientes diferenciados de Desarrollo, Prueba y Producción.

• Dominio de Tecnologías Modernas en Parte del Plantel:

Una porción del equipo se encuentra capacitada en tecnologías actuales, lo que permite encarar nuevos desarrollos con herramientas vigentes y con soporte activo de la industria.

• Infraestructura de Ambientes Diferenciados:

Existencia de ambientes diferenciados de desarrollo, prueba y producción para la ejecución del ciclo de los aplicativos.
...
• y Conocimiento Concentrado:

Prevalencia histórica de proyectos impulsados por un único desarrollador en todas las etapas del ciclo de vida, generando puntos únicos de falla e interrupciones en el soporte técnico ante licencias, vacaciones, traslados o bajas de personal.

• Proyectos a Cargo de una Sola Persona y Conocimiento Concentrado:

Muchos sistemas han sido creados y mantenidos históricamente por un solo desarrollador que hace todo el trabajo (relevamiento, desarrollo y soporte). Esto provoca que el conocimiento del sistema quede concentrado en una sola persona, haciendo muy difícil que otro agente pueda continuarlo o atenderlo ante vacaciones, licencias, traslados o jubilaciones.

• Ausencia de Metodología Común y Seguimiento Fragmentado:

No existe actualmente una metodología común para gestionar los desarrollos. Cada agente organiza sus proyectos de acuerdo con su experiencia y criterio, lo que produce diferencias en la forma de relevar, planificar, probar y documentar. Esto se evidencia en un uso fragmentado de las herramientas para registrar el avance de los proyectos (algunos agentes utilizan Redmine, otros planillas desactualizadas en Excel o registros informales), impidiendo conocer la capacidad operativa real del Departamento.

• Heterogeneidad en la documentación y Falta de un Inventario Completo:
...
• Pruebas de Software Reactivas sin Protocolo Estandarizado:

Ausencia de un procedimiento uniforme de verificación de calidad, provocando que la prueba de las funcionalidades dependa habitualmente de los propios desarrolladores que escribieron el código o directamente del reporte de errores por parte de los usuarios finales.
...
Implementación de metodologías ágiles adaptadas a la realidad municipal a costo cero para mejorar y agilizar los procesos de desarrollo, además de clarificar prioridades y optimizar la comunicación interna.
...
• Requerimientos Normativos y Operativos Imprevistos:

Surgimiento de necesidades imprevistas derivadas de cambios normativos o adecuaciones administrativas de resolución urgente, que fuerzan la reorganización del cronograma de trabajo previamente establecido
...
% de Sistemas Críticos con Referente Secundario Asignado

Tender al 100% para eliminar los *Single Points of Failure*.

**Documentación**

% de Sistemas con Documentación Técnica Mínima

Garantizar la continuidad operativa y retención del conocimiento.

**Estandarización**

% de Proyectos Nuevos alineados a la Arquitectura Base

Garantizar código escalable, mantenible y homogéneo.

**Eficiencia Procesal**

*Lead Time* de Desarrollo (Solicitud ➔ Entrega a Redes)

Reducir los tiempos de entrega mediante priorización ágil.

**Calidad de Entrega**

Tasa de Defectos Reportados en Post-Producción

Reducir fallas mediante el cumplimiento de buenas prácticas.

**Control de Terceros**

% de Desarrollos Externos con Recepción Técnica Aprobada

Asegurar la entrega de código fuente y documentación por proveedores.

**Uso de IA**

Evaluación e Integración de Herramientas de IA

Aumentar la productividad del departamento resguardando los datos.
