...
console.log('=== TESTING WINDOWS NATIVE OCR VIA POWERSHELL ===\n');

// We need to convert the raw RGBA/Gray buffer to PNG/BMP first, or extract JPEG streams from PDF.
// Let's write a node script using pdfjs-dist that exports PNG using PNGjs or canvas or pure JS BMP encoder.
...
fs.writeFileSync('d:\\proyecto\\scratch\\convert_bmps.js', script, 'utf8');
