        ...
        if (imgObj && imgObj.data) {
          ...
          for (let y = 0; y < height; y++) {
            ...
            for (let x = 0; x < width; x++) {
              const val = imgObj.data[srcRow + x];
          ...
          console.log(`Saved 24bpp page ${i} BMP: ${width}x${height}`);
        }
      }
    }
  }
...
export24bpp().catch(e => console.error(e));
