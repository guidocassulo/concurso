...
*   **Fundamento Normativo:** Decreto MGP **966/19 (Manual de Redacción), Capítulo I (Prescripciones Generales), Sección Definiciones, Punto 2 y Punto 11, Inciso a**: La circular remite a la definición de "Nota Circular / Múltiple", la cual se define como la *"Nota confeccionada en varios ejemplares de un mismo tenor y con un mismo contenido, que se dirige simultáneamente a distintos destinatarios"*. *(📋 Verificar en texto oficial de Decreto MGP 966/19)*
